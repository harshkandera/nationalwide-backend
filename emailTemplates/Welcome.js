exports.SendWelcomeEmail = (username, email) => {
    ...
    <head>
      ...
      <title>Your Nationwide-Motors-LLC account has been created!</title>
                    ...
                    <td>
                      <div style="border-radius: 4px; overflow: hidden; border: 1px solid #dddddd;">
                        ...
                        <div style="background-color: #0361FF; padding: 40px 30px; text-align: center;">
                          <h1 style="margin: 0; color: white; font-size: 36px; font-weight: 300;">Welcome to Nationwide-Motors-LLC</h1>
                        </div>
                        ...
                        <div style="background-color: white; padding: 40px 30px 30px; color: #555555;">
                          ...
                          <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px;">Thanks for creating an account on Nationwide-Motors-LLC. Your username is <strong>${username}</strong>. You can access your account area to view orders, change your password, and more at: <a href="https://Nationwide-Motors-LLC.com/dashboard/" style="color: #0361FF; text-decoration: underline;">https://Nationwide-Motors-llc.com/dashboard/</a></p>
                        ...
                        <div style="background-color: #f5f5f5; padding: 20px; text-align: center; color: #555555; font-size: 14px;">
                          <p style="margin: 0;">Nationwide-Motors-LLC</p>
                        </div>
                      </div>
                    </td>
                  </tr>
